...
static void Preferences_MenuInit( void ) {
	...
	s_preferences.background.generic.type  = MTYPE_BITMAP;
	s_preferences.background.generic.name  = BACKGROUND;
	s_preferences.background.generic.flags = QMF_INACTIVE;
	s_preferences.background.generic.x	   = 0;
	s_preferences.background.generic.y	   = 0;
	s_preferences.background.width  	   = 640;
	s_preferences.background.height  	   = 480;
...
//	s_preferences.allowdownload.generic.y	       = y;
	...
	s_preferences.back.generic.x		= 32;
	s_preferences.back.generic.y		= 480-36;
	s_preferences.back.string  		    = "back";
	s_preferences.back.color  		    = tdc_text_color;
	s_preferences.back.style         = UI_LEFT;

	Menu_AddItem( &s_preferences.menu, &s_preferences.background );
