...
static void Reset_MenuDraw( void ) {
	...
	UI_DrawProportionalString( 320, 194 + 10, "RESET GAME?", UI_CENTER|UI_INVERSE, tdc_text_color);
	UI_DrawProportionalString( s_reset.slashX, 265, "/", UI_LEFT|UI_INVERSE, tdc_text_color);
...
void UI_ResetMenu(void) {
	...
	s_reset.yes.color				= tdc_text_color;
	...
	s_reset.no.color			    = tdc_text_color;
