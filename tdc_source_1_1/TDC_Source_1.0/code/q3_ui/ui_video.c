...
static void DriverInfo_MenuDraw( void )
{
	...
	UI_DrawString( 320, 80, "VENDOR", UI_CENTER|UI_SMALLFONT,tdc_text_color );
	UI_DrawString( 320, 152, "PIXELFORMAT", UI_CENTER|UI_SMALLFONT, tdc_text_color );
	UI_DrawString( 320, 192, "EXTENSIONS", UI_CENTER|UI_SMALLFONT, tdc_text_color );
...
static void UI_DriverInfo_Menu( void )
{
	...
	s_driverinfo.background.generic.type  = MTYPE_BITMAP;
	s_driverinfo.background.generic.name  = BACKGROUND;
	s_driverinfo.background.generic.flags = QMF_INACTIVE;
	s_driverinfo.background.generic.x	  = 0;
	s_driverinfo.background.generic.y	  = 0;
	s_driverinfo.background.width  	      = 640;
	s_driverinfo.background.height  	  = 480;
	...
	s_driverinfo.back.generic.x		   = 32;
	s_driverinfo.back.generic.y		   = 480-36;
	s_driverinfo.back.string  		   = "back";
	s_driverinfo.back.color  		   = tdc_text_color;
	...
	Menu_AddItem( &s_driverinfo.menu, &s_driverinfo.background );
...
static InitialVideoOptions_s s_ivo_templates[] = //REVISAR ANITA
{
	{
	...
	},
	{
		...
		} /*ANITA AGREGO 0 , 0 ANTES DEL QTRUE*/
};
...
//  ANITA
	...
	s_ivo.ri		  = s_graphicsoptions.ri.curvalue;
//  ANITA
}
...
//			continue;
	//ANITA
		if ( s_ivo_templates[i].ct != s_graphicsoptions.ct.curvalue )
			continue;
		if ( s_ivo_templates[i].ri != s_graphicsoptions.ri.curvalue )
			continue;
	//ANITA
...
//ANITA
	...
	if (s_ivo.ri != s_graphicsoptions.ri.curvalue )
	{
		s_graphicsoptions.apply.generic.flags &= ~(QMF_HIDDEN|QMF_INACTIVE);
	}
//ANITA
...
//ANITA
	trap_Cvar_SetValue( "r_ext_compress_textures", s_graphicsoptions.ct.curvalue);
	trap_Cvar_SetValue( "r_roundImagesDown", s_graphicsoptions.ri.curvalue);
//ANITA
...
//ANITA
		...
		s_graphicsoptions.ri.curvalue          = ivo->ri;
//ANITA		
		break;
...
static void GraphicsOptions_SetMenuItems( void )
{
	...
	s_graphicsoptions.ct.curvalue = trap_Cvar_VariableValue("r_ext_compress_textures");
...
//ANITA
	static const char *compress_textures[]=
	{
		"Disabled",
		"Enabled",
		0
	};
	static const char *round_images[]=
	{
		"Disabled",
		"Enabled",
		0
...
//ANITA
	...
	s_graphicsoptions.background.generic.type  = MTYPE_BITMAP;
	s_graphicsoptions.background.generic.name  = BACKGROUND;
	s_graphicsoptions.background.generic.flags = QMF_INACTIVE;
	s_graphicsoptions.background.generic.x	   = 0;
	s_graphicsoptions.background.generic.y	   = 0;
	s_graphicsoptions.background.width  	   = 640;
	s_graphicsoptions.background.height  	   = 480;
	...
	s_graphicsoptions.graphics.color			= tdc_text_color;
	...
	s_graphicsoptions.display.color				= tdc_text_color;
	...
	s_graphicsoptions.sound.color				= tdc_text_color;
...
//	s_graphicsoptions.network.color				= color_red;
	...
	s_graphicsoptions.ct.generic.name	= "Texture Compress:";
	s_graphicsoptions.ct.generic.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.ct.generic.x	    = 400;
	s_graphicsoptions.ct.generic.y	    = y;
	s_graphicsoptions.ct.itemnames      = compress_textures;
	y += BIGCHAR_HEIGHT+2;


	s_graphicsoptions.ri.generic.type   = MTYPE_SPINCONTROL;
	s_graphicsoptions.ri.generic.name	= "Round Images:";
	s_graphicsoptions.ri.generic.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.ri.generic.x	    = 400;
	s_graphicsoptions.ri.generic.y	    = y;
	s_graphicsoptions.ri.itemnames      = round_images;
	y += 2*BIGCHAR_HEIGHT;
	...
	s_graphicsoptions.driverinfo.color            = tdc_text_color;
	y += BIGCHAR_HEIGHT+2;
	...
	s_graphicsoptions.back.generic.x		= 32;
	s_graphicsoptions.back.generic.y		= 480-36;
	s_graphicsoptions.back.string  		    = "back";
	s_graphicsoptions.back.color  		    = tdc_text_color;
	...
	s_graphicsoptions.apply.generic.x        = 640-32;
	s_graphicsoptions.apply.generic.y        = 480-36;
	s_graphicsoptions.apply.string 		     = "apply";
	s_graphicsoptions.apply.color   		 = tdc_text_color;
	s_graphicsoptions.apply.style            = UI_RIGHT;

	Menu_AddItem( &s_graphicsoptions.menu, ( void * ) &s_graphicsoptions.background );
	...
	Menu_AddItem( &s_graphicsoptions.menu, ( void * ) &s_graphicsoptions.ri);
