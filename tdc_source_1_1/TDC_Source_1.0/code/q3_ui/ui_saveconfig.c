...
static void UI_SaveConfigMenu_Init( void ) {
	...
	saveConfig.back.generic.type		= MTYPE_PTEXT;
	...
	saveConfig.back.generic.x			= 32;
	saveConfig.back.generic.y			= 480-36;
	saveConfig.back.string				= "back";
	saveConfig.back.color				= tdc_text_color;
	saveConfig.back.style				= UI_LEFT;
