...
// JPL - for NPCs
	...
	strcpy( npcs, CG_ConfigString( CS_NPCS) );
...
/*
======================
CG_StartMusic	- JPL, EHL modified
...
void CG_StartMusic( void ) {
	...
	if (music_on)
		...
		trap_S_StartBackgroundTrack( "music/silence.wav", "music/silence.wav" );
}
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum ) {
	...
	// EHL - load ammo & helth icons
	cgs.media.ammoIcon			= trap_R_RegisterShaderNoMip( "icons/ammo.tga" );
	cgs.media.healthIcon		= trap_R_RegisterShaderNoMip( "icons/health.tga" );
	cgs.media.weaponPanel		= trap_R_RegisterShaderNoMip( "icons/weaponbar.tga" );

	for (i=0; i<MAX_WEAPONS; i++) cgs.media.weaponIcon[i]=0;
	cgs.media.weaponIcon[WEAPONINDEX_TRISHOTGUN] = trap_R_RegisterShaderNoMip( "icons/icon_trishotgun.tga" );
	cgs.media.weaponIcon[WEAPONINDEX_GUN] = trap_R_RegisterShaderNoMip( "icons/icon_gun.tga" );
	cgs.media.weaponIcon[WEAPONINDEX_BONE] = trap_R_RegisterShaderNoMip( "icons/icon_bone.tga" );
	cgs.media.weaponIcon[WEAPONINDEX_MG42] = trap_R_RegisterShaderNoMip( "icons/icon_mg42.tga" );
	...
	//EHL
	cg.spawnEffectActive = qfalse;
	cg.spawnEffectEndTime = cg.time;
	cg.weaponPresentSwitch = qtrue;
	...
	// EHL
	// CG_StartMusic();
	// la música no debe comenzar al principio del nivel
