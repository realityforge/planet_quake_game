...
void G_MissileImpact( gentity_t *ent, trace_t *trace ) {
	...
	{
//		G_Printf("booom!");
		G_Sound(&g_entities[0],CHAN_VOICE,G_SoundIndex("sound/npc/sealord/sea_boom.wav"));	// sea lord "boom"
	}
