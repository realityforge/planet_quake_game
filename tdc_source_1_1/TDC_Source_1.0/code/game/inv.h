...
#define INVENTORY_GUN				5
#define INVENTORY_TRISHOTGUN		6
#define INVENTORY_MACHINEGUN		7
#define INVENTORY_GRENADELAUNCHER	8
#define INVENTORY_ROCKETLAUNCHER	9
#define INVENTORY_LIGHTNING			10
#define INVENTORY_RAILGUN			11
...
#define MODELINDEX_GUN				9
#define MODELINDEX_TRISHOTGUN		10
...
//
#define WEAPONINDEX_BONE				1
#define WEAPONINDEX_GUN					2
#define WEAPONINDEX_TRISHOTGUN			3
#define WEAPONINDEX_MG42				4
