...
int humandude; //Hal9000 our human player clientnum, used in ai_dmq3.c
...
char *ClientConnect( int clientNum, qboolean firstTime, qboolean isBot ) {
	...
	if(!isBot) {
	humandude = clientNum; //Hal9000 set humandude
	}
...
//Hal9000 give unlimited ammo to all the weapons
