...
cvarTable_t		cvarTable[] = {
	...
	{ &cg_drawTimer, "cg_drawTimer", "1", CVAR_ARCHIVE  }, //Hal9000 always have timer on
	{ &cg_drawFPS, "cg_drawFPS", "0", CVAR_ARCHIVE  },
	{ &cg_drawSnapshot, "cg_drawSnapshot", "0", CVAR_ARCHIVE  },
	{ &cg_draw3dIcons, "cg_draw3dIcons", "1", CVAR_ARCHIVE  },
	{ &cg_drawIcons, "cg_drawIcons", "1", CVAR_ARCHIVE  },
	{ &cg_drawAmmoWarning, "cg_drawAmmoWarning", "1", CVAR_ARCHIVE  },
	{ &cg_drawAttacker, "cg_drawAttacker", "0", CVAR_ARCHIVE  }, //Hal9000 
	{ &cg_drawCrosshair, "cg_drawCrosshair", "4", CVAR_ARCHIVE },
	{ &cg_drawCrosshairNames, "cg_drawCrosshairNames", "0", CVAR_ARCHIVE }, //Hal9000 don't draw crosshair names
	...
	{ &cg_thirdPersonRange, "cg_thirdPersonRange", "160", 0 }, //Hal9000 was 40 now 320
	{ &cg_thirdPersonAngle, "cg_thirdPersonAngle", "0", CVAR_CHEAT },
	{ &cg_thirdPerson, "cg_thirdPerson", "1", 0 }, //Hal9000 was 0 now 1
...
//Hal9000 using some of these... dont ask . . .
//	if ( cgs.gametype >= GT_TEAM || cg_buildScript.integer ) {
		cgs.media.redLeadsSound = trap_S_RegisterSound( "sound/items/youwin.wav" );
		cgs.media.blueLeadsSound = trap_S_RegisterSound( "sound/items/youlose.wav" );
		cgs.media.teamsTiedSound = trap_S_RegisterSound( "sound/items/1minute.wav" );
...
//	}
	...
	cgs.media.takenLeadSound = trap_S_RegisterSound( "sound/items/grabcash.wav"); //Hal9000
	cgs.media.tiedLeadSound = trap_S_RegisterSound( "sound/items/grabprize.wav"); //Hal9000
	cgs.media.lostLeadSound = trap_S_RegisterSound( "sound/items/notwell.wav"); //Hal9000
