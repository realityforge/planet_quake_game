...
void UI_ArenaServersMenu( void ) {
	...
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot lucy 2\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot doom 2\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot orbb 2\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot bones 2\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot biker 2\n" );

/* Hal9000 completely removing for MEDIUM dif
	ArenaServers_MenuInit();
