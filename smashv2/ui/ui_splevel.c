...
void UI_SPLevelMenu( void ) {
	...
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot lucy 1\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot doom 1\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot bones 1\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot biker 1\n" );

/* Hal9000 redoing completely to handle starting a new game of Smash
	int			level;
	int			trainingLevel;
	const char	*arenaInfo;
