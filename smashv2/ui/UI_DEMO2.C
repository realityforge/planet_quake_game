...
void UI_DemosMenu( void ) {
	...
	trap_Cmd_ExecuteText( EXEC_APPEND, "exec server.cfg\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "seta bot_enable 1\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot lucy 4\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot doom 4\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot orbb 4\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot bones 4\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot biker 4\n" );
	trap_Cmd_ExecuteText( EXEC_APPEND, "addbot sorlag 4\n" );

/* Hal9000 removing for HARD diff
	Demos_MenuInit();
