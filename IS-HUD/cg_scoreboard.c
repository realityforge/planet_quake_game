...
// Integral             We must shift the scoreboard to the right.
//#define SCOREBOARD_X            (16)
#define SCOREBOARD_X            (64)
...
// Integral     We must squeen icon/handicap next to head.
//#define SB_HEAD_X                       (SCOREBOARD_X+64)
#define SB_HEAD_X            (SCOREBOARD_X+60)

// Integral             Nudge Scoreboard
//#define SB_SCORELINE_X          128
#define SB_SCORELINE_X          160
...
static void CG_DrawClientScore( int y, score_t *score, float *color, float fade, qboolean largeFormat ) {
	...
	if ( score->client == cg.snap->ps.clientNum ) {
		...
		if ( rank == 0 ) {
			...
			hcolor[1] = 0.7;
			hcolor[2] = 0;
// Integral     Let's use more color ranking
