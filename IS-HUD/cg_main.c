...
// Integral     Define HUD Vars
vmCvar_t        cg_isLeftHud;
vmCvar_t        cg_isCenterHud;
vmCvar_t        cg_isBottomHud;
...
// Integral     And we's goz ta rise up!  (Default IS HUD Values)

        { &cg_isLeftHud, "cg_isLeftHud", "1", CVAR_ARCHIVE  },
        { &cg_isCenterHud, "cg_isCenterHud", "1", CVAR_ARCHIVE  },
        { &cg_isBottomHud, "cg_isBottomHud", "1", CVAR_ARCHIVE  },
