...
extern  vmCvar_t                cg_isLeftHud;
extern  vmCvar_t                cg_isCenterHud;
extern  vmCvar_t                cg_isBottomHud;
...
// Integral
void CG_LeftHud ( void );
void CG_CenterHud ( void );
void CG_BottomHud ( void );
