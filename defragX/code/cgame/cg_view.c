...
static int CG_CalcViewValues( void ) {
	...
	if ( cg.renderingThirdPerson || cgs.gametype == GT_ADVENTURE ) {
...
// SLK> sounds might not be in cg_view... create cg_sounds?
/*
=====================
