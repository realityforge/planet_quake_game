...
#define MODEL_BACK0			"gfx/ui/back_0"
#define MODEL_BACK1			"gfx/ui/back_1"
#define MODEL_SELECT		"menu/art/opponents_select"
#define MODEL_SELECTED		"menu/art/opponents_selected"
#define MODEL_ARROWS		"gfx/ui/arrows_horz_0"
#define MODEL_ARROWSL		"gfx/ui/arrows_horz_left"
#define MODEL_ARROWSR		"gfx/ui/arrows_horz_right"
...
static void PlayerModel_MenuInit( void )
{
	...
	s_playermodel.menu.fullscreen = qfalse;
	
	s_playermodel.frame.generic.type	= MTYPE_BITMAP;
	s_playermodel.frame.generic.flags	= QMF_INACTIVE;
	s_playermodel.frame.generic.name	= ART_FRAME;
	s_playermodel.frame.width			= 640;
	s_playermodel.frame.height			= 480;
	s_playermodel.frame.generic.x		= 0;
	s_playermodel.frame.generic.y		= 0;
	...
	s_playermodel.arrows.generic.x			= 160;//125
	s_playermodel.arrows.generic.y			= 435;//340;
	...
	s_playermodel.left.generic.x			= 160; //125
	s_playermodel.left.generic.y			= 435;//340;
	...
	s_playermodel.right.generic.x			= 160+65; //125+61
	s_playermodel.right.generic.y			= 435;//340;
	...
	Menu_AddItem( &s_playermodel.menu,  &s_playermodel.frame );
