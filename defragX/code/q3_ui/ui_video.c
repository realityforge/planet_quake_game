...
#define GRAPHICSOPTIONS_BACK0	"gfx/ui/back_0"
#define GRAPHICSOPTIONS_BACK1	"gfx/ui/back_1"
#define GRAPHICSOPTIONS_ACCEPT0	"gfx/ui/accept_0"
#define GRAPHICSOPTIONS_ACCEPT1	"gfx/ui/accept_1"
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.menu.fullscreen = qfalse;
	s_graphicsoptions.menu.draw       = GraphicsOptions_MenuDraw;
	
	s_graphicsoptions.frame.generic.type	= MTYPE_BITMAP;
	s_graphicsoptions.frame.generic.flags	= QMF_INACTIVE;
	s_graphicsoptions.frame.generic.name	= ART_FRAME;
	s_graphicsoptions.frame.width			= 640;
	s_graphicsoptions.frame.height			= 480;
	s_graphicsoptions.frame.generic.x		= 0;
	s_graphicsoptions.frame.generic.y		= 0;
	...
	Menu_AddItem( &s_graphicsoptions.menu, ( void * ) &s_graphicsoptions.frame );
