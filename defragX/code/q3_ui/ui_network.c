...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.menu.fullscreen = qfalse;
	
	networkOptionsInfo.frame.generic.type	= MTYPE_BITMAP;
	networkOptionsInfo.frame.generic.flags	= QMF_INACTIVE;
	networkOptionsInfo.frame.generic.name	= ART_FRAME;
	networkOptionsInfo.frame.width			= 640;
	networkOptionsInfo.frame.height			= 480;
	networkOptionsInfo.frame.generic.x		= 0;
	networkOptionsInfo.frame.generic.y		= 0;
	...
	Menu_AddItem( &networkOptionsInfo.menu, ( void * ) &networkOptionsInfo.frame );
