...
#define ID_SPEED		3
#define ID_FORWARD		4
#define ID_BACKPEDAL	5
#define ID_MOVELEFT		6
#define ID_MOVERIGHT	7
#define ID_MOVEUP		8
#define ID_MOVEDOWN		9
#define ID_LEFT			10
#define ID_RIGHT		11
#define ID_STRAFE		12
#define ID_LOOKUP		13
...
static vec4_t controls_binding_color  = {1.00f, 1.00f, 1.00f, 1.00f};

static bind_t g_bindings[] =
{
	{"+scores",			"show scores",		ID_SHOWSCORES,	ANIM_IDLE,		K_TAB,			-1,		-1, -1},
	{"+button2",		"use item",			ID_USEITEM,		ANIM_IDLE,		K_ENTER,		-1,		-1, -1},
	{"kill",			"suicide / respawn",ID_SUICIDE,		ANIM_DIE,		'v',			-1,		-1, -1},
	...
	{"+button5",		"offhand Hook",		ID_OFFHAND,		ANIM_WEAPON10,	K_MOUSE4,		-1,		-1,	-1},
...
static menucommon_s *g_misc_controls[] = {
	...
	(menucommon_s *)&s_controls.suicide,
	(menucommon_s *)&s_controls.gesture,
	(menucommon_s *)&s_controls.offhand,
...
=================
*/
static void Controls_ResetDefaults_Action( qbool result ) {
	if( !result ) {
		return;
	}
...
static void Controls_MenuInit( void )
{
	...
	s_controls.menu.fullscreen = qfalse;
	
	s_controls.frame.generic.type	= MTYPE_BITMAP;
	s_controls.frame.generic.flags	= QMF_INACTIVE;
	s_controls.frame.generic.name	= ART_FRAME;
	s_controls.frame.width			= 640;
	s_controls.frame.height			= 480;
	s_controls.frame.generic.x		= 0;
	s_controls.frame.generic.y		= 0;
	...
	s_controls.looking.color			= colorWhite;
	...
	s_controls.movement.color			= colorWhite;
	...
	s_controls.weapons.color			= colorWhite;
	...
	s_controls.misc.color			= colorWhite;
	...
	s_controls.suicide.generic.type	     = MTYPE_ACTION;
	s_controls.suicide.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.suicide.generic.callback  = Controls_ActionEvent;
	s_controls.suicide.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.suicide.generic.id        = ID_SUICIDE;
	...
	s_controls.offhand.generic.type	     = MTYPE_ACTION;
	s_controls.offhand.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.offhand.generic.callback  = Controls_ActionEvent;
	s_controls.offhand.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.offhand.generic.id        = ID_OFFHAND;
	...
	Menu_AddItem( &s_controls.menu, &s_controls.frame );
	...
	Menu_AddItem( &s_controls.menu, &s_controls.suicide );
	Menu_AddItem( &s_controls.menu, &s_controls.gesture );
	Menu_AddItem( &s_controls.menu, &s_controls.offhand );
