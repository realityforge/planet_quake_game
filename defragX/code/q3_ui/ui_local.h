...
typedef struct
{
	...
	int		maxchars;
	qbool skipKey; // skip single key event
} mfield_t;
...
extern void UI_ConfirmMenu_Style( const char *question, int style, void (*draw)( void ), void (*action)( qbool result ) );
...
qbool		    trap_VerifyCDKey( const char *key, const char *chksum); // bk001208 - RC4
