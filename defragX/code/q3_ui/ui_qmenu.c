...
vec4_t text_color_normal    = {0.25f, 0.65f, 1.00f, 1.00f}; // SLK
vec4_t text_color_highlight = {0.70f, 0.70f, 1.00f, 1.00f}; // SLK
vec4_t listbar_color        = {1.00f, 1.00f, 1.00f, 0.30f};	// SLK
...
void Menu_Cache( void )
{
	...
	uis.charsetPropB	= trap_R_RegisterShaderNoMip( "gfx/2d/font2_prop.tga" );
	uis.cursor          = trap_R_RegisterShaderNoMip( "gfx/ui/cursor" );
	uis.rb_on           = trap_R_RegisterShaderNoMip( "gfx/ui/switch_on" );
	uis.rb_off          = trap_R_RegisterShaderNoMip( "gfx/ui/switch_off" );

	uis.whiteShader     = trap_R_RegisterShaderNoMip( "white" );
    uis.menuBackShader	= trap_R_RegisterShaderNoMip( "menuback" );

    sliderBar           = trap_R_RegisterShaderNoMip( "gfx/ui/slider2" );
	sliderButton_0      = trap_R_RegisterShaderNoMip( "gfx/ui/sliderbutt_0" );
	sliderButton_1      = trap_R_RegisterShaderNoMip( "gfx/ui/sliderbutt_1" );

	menu_in_sound	    = trap_S_RegisterSound( "sound/misc/menu1.wav", qfalse );
	menu_move_sound	    = trap_S_RegisterSound( "sound/misc/silence.wav", qfalse );
