...
#define ART_GO0				"gfx/ui/play_0"
#define ART_GO1				"gfx/ui/play_1"
#define ART_ARROWS_VERT		"gfx/ui/arrows_vert_0"
#define ART_ARROWS_UP		"gfx/ui/arrows_vert_top"
#define ART_ARROWS_DOWN		"gfx/ui/arrows_vert_bot"

#define UI_DEMO_LENGTH      64
#define UI_MAX_DEMOS        2048 //1024
...
===============
*/
static qbool UI_UpdateDirectory( char *name ) {
	char *s;
...
static void Demos_MenuInit( void ) {
	...
	s_demos.frame.generic.type	= MTYPE_BITMAP;
	s_demos.frame.generic.flags	= QMF_INACTIVE;
	s_demos.frame.generic.name	= ART_FRAME;
	s_demos.frame.width			= 640;
	s_demos.frame.height		= 480;
	s_demos.frame.generic.x		= 0;
	s_demos.frame.generic.y		= 0;
	...
	Menu_AddItem( &s_demos.menu, &s_demos.frame );
