...
// KILDEREAN : to determine what model we are choosing
#define CHOOSING_MAIN	0
#define CHOOSING_BLUE	1
#define CHOOSING_RED	2
...
static void PlayerModel_SaveChanges( void )
{
 	...
 	if(model_choice == CHOOSING_BLUE){
 		ptr = strchr(s_playermodel.modelskin, '/');
 		*ptr = '\0';
 		trap_Cvar_Set( "cg_PureBluemodel", s_playermodel.modelskin );
		trap_Cvar_Set( "cg_PureBlueHeadmodel", s_playermodel.modelskin );
 	}
 	if(model_choice == CHOOSING_RED){
 		ptr = strchr(s_playermodel.modelskin, '/');
 		*ptr = '\0';
 		trap_Cvar_Set( "cg_PureRedmodel", s_playermodel.modelskin );
		trap_Cvar_Set( "cg_PureRedHeadmodel", s_playermodel.modelskin );
 	}
	//END KILDEREAN
}
...
// KILDEREAN
void UI_PlayerModelMenuBlue(void)
{
 	model_choice = CHOOSING_BLUE;
...
void UI_PlayerModelMenuRed(void)
{
 	model_choice = CHOOSING_RED;
