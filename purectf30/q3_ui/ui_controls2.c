...
// KILDEREAN
#define ID_WEAPON10		26  // grappling hook 
// END KILDEREAN
#define ID_ATTACK		27
...
#define ID_CHAT4		34
// KILDEREAN
#define ID_DROPRUNE		35  // drop rune cmd
// END KILDEREAN
...
static vec4_t controls_binding_color  = {1.00, 0.43f, 0.00f, 1.00};
...
static bind_t g_bindings[] = 
{
	...
	{"messagemode4", 	"chat - attacker",	ID_CHAT4,		ANIM_CHAT,		-1,				-1,		-1, -1},
 	// KILDEREAN
 	{"drop rune", 		"drop rune",		ID_DROPRUNE,	ANIM_DROPRUNE,	'p',			-1,		-1, -1},
 	// END KILDEREAN
