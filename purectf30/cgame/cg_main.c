...
// KILDEREAN
vmCvar_t	cg_PureFlagDLight;
vmCvar_t	cg_PureFlagTrail;
vmCvar_t	cg_PureBluemodel;
vmCvar_t	cg_PureBlueHeadmodel;
vmCvar_t	cg_PureRedmodel;
vmCvar_t	cg_PureRedHeadmodel;
// END KILDEREAN
...
cvarTable_t		cvarTable[] = {
	...
	// KILDEREAN : default to force model
	...
	// KILDEREAN : make default not seeing the yellow arrow
	...
	{ &cg_bigFont, "ui_bigFont", "0.4", CVAR_ARCHIVE},
 	...
 	// KILDEREAN
	// FIXME: make default team models stay to what is specified here
 	{ &cg_PureFlagDLight, "cg_PureFlagDLight", "1", CVAR_ARCHIVE },
 	{ &cg_PureFlagTrail, "cg_PureFlagTrail", "1", CVAR_ARCHIVE },	
	{ &cg_PureBluemodel, "cg_PureBluemodel", "ranger", CVAR_ARCHIVE },
	{ &cg_PureBluemodel, "cg_PureBlueHeadmodel", "ranger", CVAR_ARCHIVE },
 	{ &cg_PureRedmodel, "cg_PureRedmodel", "doom", CVAR_ARCHIVE },
	{ &cg_PureRedmodel, "cg_PureRedHeadmodel", "doom", CVAR_ARCHIVE },
	// END KILDEREAN
...
void CG_RegisterCvars( void ) {
	...
	blueteamModelModificationCount = cg_PureBluemodel.modificationCount;
	redteamModelModificationCount = cg_PureRedmodel.modificationCount;
...
void CG_UpdateCvars( void ) {
	...
	// KILDEREAN : if we change one of the team models, reload them now
	if(blueteamModelModificationCount != cg_PureBluemodel.modificationCount || redteamModelModificationCount != cg_PureRedmodel.modificationCount){
		blueteamModelModificationCount = cg_PureBluemodel.modificationCount;
		redteamModelModificationCount = cg_PureRedmodel.modificationCount;
		CG_ForceModelChange();	
	}
...
//		}
	...
	// KILDEREAN : moved from out of the ifdef since this is obviously part of TA
	...
	cgs.media.hgrenb2aSound = trap_S_RegisterSound("sound/weapons/grenade/hgrenb2a.wav", qfalse);
 	...
 	// KILDEREAN
 	cgs.media.quadstrengthSound = trap_S_RegisterSound ("sound/items/quad_strength.wav", qfalse );
 	cgs.media.strengthSound = trap_S_RegisterSound("sound/items/strength.wav", qfalse);
	cgs.media.resistSound = trap_S_RegisterSound("sound/items/resistance.wav", qfalse);
 	cgs.media.hasteSound = trap_S_RegisterSound("sound/items/haste.wav", qfalse);
 	cgs.media.regenpureSound = trap_S_RegisterSound("sound/items/regen.wav", qfalse);
 	cgs.media.sfx_PureGrapple = trap_S_RegisterSound ("sound/pure3/grapple/dink.wav", qfalse);
	cgs.media.strPickup = trap_S_RegisterSound("sound/items/strpickup.wav", qfalse);
	cgs.media.resPickup = trap_S_RegisterSound("sound/items/respickup.wav", qfalse);
	cgs.media.hasPickup = trap_S_RegisterSound("sound/items/haspickup.wav", qfalse);
	cgs.media.regPickup = trap_S_RegisterSound("sound/items/regpickup.wav", qfalse);
	cgs.media.gong = trap_S_RegisterSound("sound/events/gong.wav", qfalse);
 	// END KILDEREAN
...
static void CG_RegisterGraphics( void ) {
	...
	for ( i=0 ; i<11 ; i++) {
 	...
 	// KILDEREAN : fixed mipped AI skill
	...
	cgs.media.hastePuffShader = trap_R_RegisterShader("hasteSmokePuff" );
 	...
 	// KILDEREAN
 	cgs.media.strengthShader = trap_R_RegisterShader("powerups/strength");
 	cgs.media.strengthWeaponShader = trap_R_RegisterShader("powerups/strengthWeapon");
 	cgs.media.regenWeaponShader = trap_R_RegisterShader("powerups/regenWeapon" );
 	cgs.media.resistanceShader1 = trap_R_RegisterShader("powerups/resistance1" );
 	cgs.media.resistanceShader2 = trap_R_RegisterShader("powerups/resistance2" );
 	cgs.media.resistanceWeaponShader1 = trap_R_RegisterShader("powerups/resistanceWeapon1" );
 	cgs.media.resistanceWeaponShader2 = trap_R_RegisterShader("powerups/resistanceWeapon2" );
 	cgs.media.hastepureShader = trap_R_RegisterShader("powerups/hastepure" );
 	cgs.media.hastepureWeaponShader = trap_R_RegisterShader("powerups/hastepureWeapon" );
	cgs.media.teamBlueShader = trap_R_RegisterShaderNoMip("icons/team_blue.tga");
	cgs.media.teamRedShader = trap_R_RegisterShaderNoMip("icons/team_red.tga");
	cgs.media.blueShield = trap_R_RegisterShader("powerups/supershield_blue");
	cgs.media.redShield = trap_R_RegisterShader("powerups/supershield_red");
	cgs.media.lgDischargeFX = trap_R_RegisterShader ("models/weaphits/electric");
 	// END KILDEREAN
	...
	if ( cgs.gametype == GT_CTF || cg_buildScript.integer ) {
		...
		cgs.media.blueFlagShader[2] = trap_R_RegisterShaderNoMip( "icons/iconf_blu3" );
 		...
 		// KILDEREAN
 		cgs.media.blueflagPuffShader = trap_R_RegisterShader("models/powerups/instant/str_glow" );
 		cgs.media.redflagPuffShader = trap_R_RegisterShader("models/powerups/instant/reg_glow" );
 		// END KILDEREAN
	...
	cgs.media.dishFlashModel = trap_R_RegisterModel("models/weaphits/boom01.md3");
 	...
 	// KILDEREAN
 	cgs.media.grapHitModel = trap_R_RegisterModel("models/weaphits/graphit.md3");
 	// END KILDEREAN
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum ) {
	...
	cg.weaponSelect = WP_MACHINEGUN;
 	...
 	// KILDEREAN
 	cg.inOvertime = qfalse;
 	cg.inOvertimeWarmup = qfalse;
 	cg.getReadyForOT = qfalse;
 	cg.currentOTRound = -1;
 	// END KILDEREAN
