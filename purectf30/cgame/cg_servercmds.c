...
void CG_ParseServerinfo( void ) {
	...
	cgs.maxclients = atoi( Info_ValueForKey( info, "sv_maxclients" ) );
 	...
 	// KILDEREAN: g_PureAllowHook g_PureRunes from server
 	cgs.allowhook = atoi( Info_ValueForKey( info, "g_PureAllowHook" ) );
 	cgs.purerunes = atoi( Info_ValueForKey( info, "g_PureRunes" ) );
 	cgs.discharge = atoi( Info_ValueForKey( info, "g_PureLGDischarge" ) );
 	cgs.fastGrapple = atoi( Info_ValueForKey( info, "g_PureFastHook" ) );
 	cgs.otWarmup = atoi ( Info_ValueForKey(info, "g_PureOTWarmupTime"));
	cgs.RAOtEnabled = atoi( Info_ValueForKey( info, "g_PureRAOvertime" ) );
	cgs.RA_CTF = atoi(Info_ValueForKey( info, "g_PureRA_CTF" ));
	// END KILDEREAN
