...
*/
	{
		...
		"sound/misc/w_pkup.wav",
		// KILDEREAN
        { "models/weapons2/grapple2/grapple2.md3", 
		// END KILDEREAN
		0, 0, 0},
...
*/
	{
		"ammo_multi",
		"sound/misc/am_pkup.wav",
        { "models/powerups/ammo/multi_am.md3", 
		0, 0, 0},
/* icon */		"icons/icona_multi",
/* pickup */	"Multiple Ammo",
		0,
		IT_AMMO,
		WP_MULTI,
/* precache */ "",
...
/* sounds */ ""
 ...
 //KILDEREAN : Pure runes
/*QUAKED item_strength_pure (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
 	{
 		"item_strength_pure",
 		"sound/items/strength.wav",
         { "models/powerups/instant/strength.md3", 
 		"models/powerups/instant/strength_ring.md3", 
 		0, 0 },
/* icon */		"icons/strength",
...
/*QUAKED item_resistance_pure (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
 	{
 		"item_resistance_pure",
 		"sound/items/resistance.wav",
         { "models/powerups/instant/resistance.md3", 
 		"models/powerups/instant/resistance_ring.md3", 
 		0, 0 },
/* icon */		"icons/resistance",
/* pickup */	"Resistance Rune",
 		0,
 		IT_POWERUP,
 		PW_RESISTANCE_PURE,
/* precache */ "",
...
/*QUAKED item_haste_pure (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
 	{
 		"item_haste_pure",
        "sound/items/haste.wav",
        { "models/powerups/instant/hastepure.md3",
        "models/powerups/instant/hastepure_ring.md3",
        0, 0 },
/* icon */      "icons/haste_rune",
/* pickup */    "Haste Rune",
         0,
        IT_POWERUP,
        PW_HASTE_PURE,
...
/*QUAKED item_regen_pure (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
   {
        "item_regen_pure",
        "sound/items/regen.wav",
        { "models/powerups/instant/regeneration.md3",
        "models/powerups/instant/regeneration_ring.md3",
         0, 0 },
/* icon */      "icons/regen_rune",
/* pickup */    "Regeneration Rune",
        0,
         IT_POWERUP,
        PW_REGEN_PURE,
/* precache */ "",
...
// KILDEREAN : find multi ammo box item
gitem_t	*BG_FindMultiAmmo() {
	gitem_t	*it;
	
	for ( it = bg_itemlist + 1 ; it->classname ; it++) {
		if ( it->giType == IT_AMMO && it->giTag == WP_MULTI ) {
			return it;
		}
	}

	Com_Error( ERR_DROP, "Couldn't find item for multi ammo box");
	return NULL;
}
// END KILDEREAN
...
qboolean BG_CanItemBeGrabbed( int gametype, const entityState_t *ent, const playerState_t *ps ) {
	...
	case IT_POWERUP:
		//KILDEREAN : don't pick up runes if already got one
 		if((ps->powerups[PW_STRENGTH_PURE]||
 			ps->powerups[PW_RESISTANCE_PURE]||
 			ps->powerups[PW_REGEN_PURE]||
 			ps->powerups[PW_HASTE_PURE])
 			&&
 			(!strcmp(item->classname, "item_strength_pure")||
 			!strcmp(item->classname, "item_resistance_pure")||
			!strcmp(item->classname, "item_regen_pure")||
 			!strcmp(item->classname, "item_haste_pure")))
			return qfalse;
		else{
			if(ps->powerups[PW_DROPPED_RUNE] == item->giTag)
				return qfalse;
			else
