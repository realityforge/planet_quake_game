...
void TossClientItems( gentity_t *self ) {
	...
	//PANTS - excessive doesn't drop weapons
...
void G_Damage( gentity_t *targ, gentity_t *inflictor, gentity_t *attacker,
	...
	//PANTS - extra knockback
	if(strcmp(inflictor->classname, "grenade") == 0)
		knockback *= 4;
	else if(strcmp(inflictor->classname, "plasma") == 0)
		knockback += 100;
	else if(strcmp(inflictor->classname, "bfg") == 0)
		knockback += 50;
	...
	//PANTS - if someone is grappled to you, shoot him to disconnect it
...
//PANTS - no self damage
	if((attacker == targ) && ((dflags & DAMAGE_NO_PROTECTION) == 0))
		return;

	//PANTS - no falling damage
	if(mod == MOD_FALLING)
		return;
