...
void CG_TransitionPlayerState( playerState_t *ps, playerState_t *ops ) {
	...
	// ========================================
	// SHUD re-inits on changing follow mode :(
	// ========================================
         cons_hits_all = max_cons_hits_all = 0;
         avg_armor_sum = avg_health_sum = 0;
         armor_picked_up = 0;
         start_time = cgs.levelStartTime;
         avg_last_time = 0;
         last_time2 = cg.time - cgs.levelStartTime;
         max_xyspeed = 0;
         last_acc_f = ps->persistant[PERS_ACCURACY_SHOTS];
         last_acc_h = ps->persistant[PERS_ACCURACY_HITS];

	   memset( acc_weap_h, 0, sizeof(int)*MAX_WEAPONS );
	   memset( acc_weap_f, 0, sizeof(int)*MAX_WEAPONS );
	...
	// ==============================================
	// SHUD re-inits on changing follow mode :( [end]
	// ==============================================
