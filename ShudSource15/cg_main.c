...
// ======================
// SHUD Main declarations
// ======================
vmCvar_t 	cg_drawAccuracy;
vmCvar_t 	cg_drawAccuracyStyle;
vmCvar_t 	cg_advScoreboard;
vmCvar_t 	cg_fragsPerTime;
vmCvar_t 	cg_clientsOnScoreboard;
vmCvar_t 	cg_SHUDLogFile;
vmCvar_t 	cg_SHUDLogTemplate;
vmCvar_t 	cg_SHUDAutoLog;
vmCvar_t	cg_drawTimeUnderPowerup;

advscore_t stats[MAX_CLIENTS];

qhandle_t medal_Accuracy;
qhandle_t medal_Victory;
qhandle_t medal_Frags;
qhandle_t icon_Deaths;
qhandle_t icon_Suicides;
qhandle_t scoreboardStats;
qhandle_t iconr_shard;
qhandle_t iconh_red;
qhandle_t icon_haste;
int acc_weap_h[MAX_WEAPONS],acc_weap_f[MAX_WEAPONS],last_acc_h, last_acc_f, col_f, col_h;
int cons_hits[MAX_WEAPONS], cons_hits_all,max_cons_hits[MAX_WEAPONS], max_cons_hits_all;
int avg_armor_sum,avg_health_sum,avg_armor,avg_health,avg_last_time,start_time;
int teamred_getflag, teamred_getbacks,teamblue_getflag, teamblue_getbacks;
int armor_picked_up,level_end_time;
int team_blead_time,team_rlead_time,team_equal_time;
int sh_id,last_time2;
int time_under_powerup[PW_NUM_POWERUPS];
int prev_time_under_powerup[PW_NUM_POWERUPS];
int lead_time,lose_time,equal_time;
int SHUDLog_Status;
int pow_of2[16];
float max_xyspeed;
qboolean initdemo;
...
cvarTable_t		cvarTable[] = {
	...
	// SHUD Cvars
 	...
 	{ &cg_drawAccuracyStyle, "cg_drawAccuracyStyle", "0", CVAR_ARCHIVE },
 	{ &cg_advScoreboard, "cg_advScoreboard", "0", CVAR_ARCHIVE },
 	{ &cg_fragsPerTime, "cg_fragsPerTime", "3600", CVAR_ARCHIVE },
 	{ &cg_clientsOnScoreboard, "cg_clientsOnScoreboard", "8", CVAR_ARCHIVE },
 	{ &cg_SHUDLogFile, "cg_SHUDLogFile", "Stats.html", CVAR_ARCHIVE },
 	{ &cg_SHUDLogTemplate, "cg_SHUDLogTemplate", "Template.html", CVAR_ARCHIVE },
 	{ &cg_SHUDAutoLog, "cg_SHUDAutoLog", "0", CVAR_ARCHIVE },
 	{ &cg_drawTimeUnderPowerup, "cg_drawTimeUnderPowerup", "0", CVAR_ARCHIVE },
	// ================
	// SHUD Cvars [end]
 	// ================
...
static void CG_RegisterGraphics( void ) {
	...
	// SHUD media
 	// ==========
	medal_Accuracy = trap_R_RegisterShaderNoMip( "menu/medals/medal_accuracy.tga" );
   	medal_Victory = trap_R_RegisterShaderNoMip( "menu/medals/medal_victory.tga" );
   	medal_Frags = trap_R_RegisterShaderNoMip( "menu/medals/medal_frags.tga" );
	iconr_shard  = trap_R_RegisterShaderNoMip( "icons/iconr_shard" );
 	iconh_red = trap_R_RegisterShaderNoMip( "icons/iconh_red" );
 	icon_haste = trap_R_RegisterShaderNoMip( "icons/haste" );
 	icon_Deaths = trap_R_RegisterShaderNoMip( "icons/icon_Deaths.tga" );
 	icon_Suicides = trap_R_RegisterShaderNoMip( "icons/icon_Suicides.tga" );
	
	scoreboardStats = trap_R_RegisterShaderNoMip( "menu/tab/stats.tga" );
	// ================
	// SHUD media [end]
 	// ================
...
//      start_time = cgs.levelStartTime;
	start_time = -1;
 	level_end_time = -1;
      ...
      LogRequest = qfalse;
   	pow_of2[0]=1;
   	while(i<16) { pow_of2[i] = pow_of2[i-1]*2; i++;};
	// ================
	// SHUD inits [end]
 	// ================
