// UIE_ICONS.SHADER
//
// UI Enhanced icon shaders
// http://www.planetquake.com/uie/
// Derived from default Id gfx shaders
// HypoThermia

//
// holdable item icons
//
uie_icons/teleporter
{
	nopicmip
	{
