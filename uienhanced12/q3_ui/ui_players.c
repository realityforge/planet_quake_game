...
==========================
*/
static qboolean UI_RegisterClientSkin( playerInfo_t *pi, const char *modelName, const char *skinName , qboolean head)
{
...
qboolean UI_RegisterClientModelname( modelAnim_t* m)
{
	...
	char		*modelSkinName, *modelHeadName;
	...
	if ( !UI_RegisterClientSkin( pi, bodyName, skinBodyName, qfalse ) ) {
		if ( !UI_RegisterClientSkin( pi, bodyName, "default", qfalse ) ) {
	...
	if ( !UI_RegisterClientSkin( pi, headName, skinHeadName, qtrue ) ) {
		if ( !UI_RegisterClientSkin( pi, headName, "default", qtrue ) ) {
...
void UIE_PlayerInfo_AnimateModel( modelAnim_t* m)
{
	menubitmap_s* b;
	char buffer[MODELNAME_BUFFER];
	qboolean modelchange, team_modelchange, draw_team;
	float f;
