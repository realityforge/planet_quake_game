...
static imageSource_t uieImageList[] = {
	{ 100, "menu/uie_art/uie_logo_button.tga", 1.0, 0, NULL, 0.0, 0 },	// displayed on first pass
...
//	{ CMODE_TEXT, "", { "", 0, 0, 0 } },
	{ CMODE_TEXT, "UI Enhanced", {0, 0, 0, 0} },
	{ CMODE_TEXT, "Developed by", { "Ian `HypoThermia` Jefferies", 0, 0, 0} },
	{ CMODE_TEXT, "UIE Homepage", { "www.planetquake.com/uie", 0, 0, 0 } },
	{ CMODE_SILLYTITLE, 0, {0, 0, 0, 0} },
	{ CMODE_TEXT, "Additional Code", { "Joel `Johnny Law` Baxter", "Author of MoreMaps", 0, 0 } },
	{ CMODE_TEXT, "Map Scripts", { "BFG-Berater, Johnny Law, Kevin Knight", "DeSiRe, Sascha Lichtenstein", 0, 0 } },
	{ CMODE_TEXT, "Additional Help", { "Sascha Lichtenstein, Kevin Knight", "Dagwit, Rogue13, Sludge", 0, 0 } },
	{ CMODE_TEXT, "UIE also appears in", { 0, 0, 0, 0 } },
	{ CMODE_TEXT, "Threewave Unification", { "www.threewave.com", 0, 0, 0 } },
	{ CMODE_TEXT, "Corven's Eternal Arena", { "www.q3center.com/ea", 0, 0, 0 } },
	{ CMODE_TEXT, "JailBreak:POW", { "www.planetquake.com/bkp", 0, 0, 0 } },
	{ CMODE_TEXT, "Invaluable Support" , { "All who have provided suggestions", "enthusiasm, bug reports, hosting,", " and announcement of new releases", 0 } },
	{ CMODE_TEXT, "Clan ECA", { "Stormrider, Ajare, KillingTime", "The BlueCat, BuDa, Wrah, Gogsie", "and all other members", "(past and present)" } },
	{ CMODE_QUOTE, 0, {0, 0, 0, 0} }
};


static creditEntry_t id_credits[] = {
	{ CMODE_TEXT, "Quake III Arena", { 0, 0, 0, 0 } },

	{ CMODE_DUALTEXT, "Programming", { "John Carmack, Robert A. Duffy", "Jim Dose'", 0, 0 } },
	{ CMODE_DUALTEXT, "Art", { "Adrian Carmack, Kevin Cloud", "Kenneth Scott, Seneca Menard", "Fred Nilsson", 0 } },

	{ CMODE_DUALTEXT, "Game Designer", { "Graeme Devine", 0, 0, 0 } },
	{ CMODE_DUALTEXT, "Level Design", { "Tim Willits, Christian Antkow", "Paul Jaquays", 0, 0 } },

	{ CMODE_DUALTEXT, "CEO", { "Todd Hollenshead", 0, 0, 0 } },
	{ CMODE_DUALTEXT, "Director of Biz Dev", { "Marty Stratton", 0, 0, 0 } },

	{ CMODE_DUALTEXT, "Biz Assist and id Mom", { "Donna Jackson", 0, 0, 0 } },
	{ CMODE_DUALTEXT, "Development Assistance", { "Eric Webb", 0, 0, 0 } },

	{ CMODE_TEXT, "Quake III Arena", { "(c) 1999-2000, Id Software, Inc.", "All Rights Reserved", 0, 0 } }
};
