...
**  	ui_rally_server.c
**
**  	Q3R server browser and multiplayer menus.  Based on original q3 
...
static char quake3worldMessage[] = "Visit www.quakerally.com - News, Forums, Files";
// END
...
// STONELANCE
		...
		if( g_rallyonly	&& Q_stricmp( GAME_DIRECTORY, servernodeptr->gamename ) ) {
			continue;
		}
// END
