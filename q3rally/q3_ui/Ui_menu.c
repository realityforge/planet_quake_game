...
// STONELANCE
		...
		UI_DrawString( 320, 460, GAME_VERSION " (c) 2002 Team Quake III Rally | WWW.QUAKERALLY.COM", UI_CENTER|UI_SMALLFONT, text_color_normal );
...
// STONELANCE
	...
	s_main.banner.string					= "QUAKE III RALLY";
