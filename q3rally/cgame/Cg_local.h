...
extern	vec4_t				bgColor; // STONELANCE - UPDATE change variable name?
// END
...
// SKWID( replaced player with car )
	lerpFrame_t		body, flag; // STONELANCE UPDATE: still need this body lerp?
...
// STONELANCE - UPDATE dont need this headOffset or footsteps and gender maybe?
...
// STONELANCE( add head support and custom rims )
	// other models
...
// STONELANCE UPDATE dont need animations?
