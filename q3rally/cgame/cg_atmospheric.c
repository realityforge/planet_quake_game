...
**
**		StoneLance:
**			Made major modifications to support area atmospheric effects
**			and only drawing particles when they are in FOV.
*/
...
// STONELANCE - if the particle has left our view then move it back into our view
...
// STONELANCE - replaced with a single cvar
...
// STONELANCE - changed to one cvar
