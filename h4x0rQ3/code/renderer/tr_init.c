...
void R_Register( void ) 
{
	...
	r_intensity = ri.Cvar_Get ("r_intensity", "1.35", CVAR_ARCHIVE | CVAR_LATCH );
	...
	r_railWidth = ri.Cvar_Get( "r_railWidth", "2", CVAR_ARCHIVE );
	r_railCoreWidth = ri.Cvar_Get( "r_railCoreWidth", "2", CVAR_ARCHIVE );
	r_railSegmentLength = ri.Cvar_Get( "r_railSegmentLength", "1", CVAR_ARCHIVE );
