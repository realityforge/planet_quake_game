...
void CL_Init( void ) {
	...
	cl_aviFrameRate = Cvar_Get ("cl_aviFrameRate", "60", CVAR_ARCHIVE);
	cl_aviMotionJpeg = Cvar_Get ("cl_aviMotionJpeg", "1", CVAR_ARCHIVE);
	cl_forceavidemo = Cvar_Get ("cl_forceavidemo", "1", 0);
	...
	cl_sensitivity = Cvar_Get ("sensitivity", "6", CVAR_ARCHIVE);
	cl_mouseAccel = Cvar_Get ("cl_mouseAccel", "0", CVAR_ARCHIVE);
	cl_freelook = Cvar_Get( "cl_freelook", "1", CVAR_ARCHIVE );

	// mouse accel limit  for cnq3's code
	...
	cl_conColor = Cvar_Get( "cl_conColor", "84 84 84 224", CVAR_ARCHIVE);
	...
	m_cnq3 = Cvar_Get ("m_cnq3", "0", CVAR_ARCHIVE);
	...
	// userinfo
	Cvar_Get ("name", "^3Unnamed^7Player", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("rate", "25000", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("snaps", "40", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("model", "ranger/pm", CVAR_USERINFO | CVAR_ARCHIVE );
