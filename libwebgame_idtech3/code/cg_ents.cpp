...
static void CG_EntityEffects( centity_t *cent ) {
	...
	return; // no clue what the constant light glow is for... see no difference, so fuck it
	// constant light glow
...
*/
	// add dynamic light
	if ( weapon->missileDlight ) {
		// disable rocket lights for now, lags as fuck
...
static void CG_Portal( centity_t *cent ) {
	...
	VectorSubtract( vec3_origin, ent.axis[1], ent.axis[1] ); // negating this tends to get the directions like they want we really should have a camera roll value
...
static void CG_TeamBase( centity_t *cent ) {
	refEntity_t model;
	// looks kinda interesting, not deleting it yet
	return;
