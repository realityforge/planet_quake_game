...
#define	MINS_Z				-24
#define	DEFAULT_VIEWHEIGHT	36 // was 26, but Jedi Academy uses this
...
#define PMF_LADDER          32768   // ripped from et:legacy
...
typedef struct {
	...
	int imgui; // true once a frame in first chopped PmoveSingle
	int chopcount;
	// callbacks to test the world
	// these will be different functions during game and cgame
	void		(*trace)( trace_t *results, vec3_t start, vec3_t mins, vec3_t maxs, vec3_t end, int passEntityNum, int contentMask );
...
CCALL gitem_t	*BG_FindItem( const char *pickupName );
