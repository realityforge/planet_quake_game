...
void CM_LoadMap( const char *name, qboolean clientload, int *checksum ) {
	...
	#if EMSCRIPTEN
			EM_ASM_({
				CM_LoadMap_callback($0, $1, $2);
			}, name, clientload, checksum);
	#endif
}

// CM_LoadMap only calls javascript, there I load the .bsp into WebAssembly memory
// then I call this function from javascript
// this way I dont need to precacheany .bsp files on startmap... load a map.. fetch exactly one bsp
CCALL void CM_LoadMap_real( const char *name, qboolean clientload, int *checksum ) {
