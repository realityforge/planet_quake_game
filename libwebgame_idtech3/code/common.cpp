...
void Com_ParseCommandLine( char *commandLine ) {
	...
	//printf("Com_ParseCommandLine> before commandLine=%d\n", commandLine);
	...
	//printf("Com_ParseCommandLine> after\n");
}
...
int Com_EventLoop( void ) {
	...
	while ( 1 ) {
		...
		//Com_Printf("Com_EventLoop event=%d %d %d\n", ev.evType, ev.evValue, ev.evValue2);
