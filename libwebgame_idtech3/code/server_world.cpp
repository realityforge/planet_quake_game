...
*/
CCALL trace_t jl_trace(vec3_t start, vec3_t mins, vec3_t maxs, vec3_t endpos, int passEntityNum, int contentmask, int capsule) {
	trace_t result;
	SV_Trace(&result, start, mins, maxs, endpos, passEntityNum, contentmask, capsule);
	return result;
}
