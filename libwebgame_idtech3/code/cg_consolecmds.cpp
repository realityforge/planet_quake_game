...
CCALL float viewpos_x() {
	return cg.refdef.vieworg[0];
}
CCALL float viewpos_y() {
	return cg.refdef.vieworg[1];
}
CCALL float viewpos_z() {
	return cg.refdef.vieworg[2];
}
CCALL float viewpos_yaw() {
	return cg.refdefViewAngles[YAW];
}
CCALL float viewpos_pitch() {
	return cg.refdefViewAngles[PITCH];
}
CCALL float viewpos_roll() {
	return cg.refdefViewAngles[ROLL];
}
