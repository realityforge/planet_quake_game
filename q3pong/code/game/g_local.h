...
struct gclient_s {
	...
	int			goalieTime;	// time the player became a goalie.  if someone else on the team has an earlier time, the player is pushed out
  qboolean switchTeams; // if qtrue, switch teams next time the player spawns
};
