...
spawn_t	spawns[] = {
	...
	{"info_gameball_start", SP_info_gameball_start},
	{"trigger_killball", SP_trigger_ball_kill},
	//END RXN MOD
...
qboolean G_CallSpawn( gentity_t *ent ) {
	...
	for ( item=bg_itemlist+1 ; item->classname ; item++ ) {
      ...
      if (g_weapon.integer && (item->giType == IT_WEAPON || item->giType == IT_AMMO)){
        continue;
      }
      // found it
