...
#define CS_LOCATIONS			(CS_SKINS+MAX_CLIENTS)
...
typedef enum {
	...
	GT_JAIL, // jailbreak-pong

		// note: *cannot* use gametype 2.  it's normally gt_singleplayer, quake3 won't allow
		// gametype 2 in multiplayer (forces it to 0)
...
#define PMF_GRAPPLE_PULL	0x00000200	// pull towards grapple location
#define PMF_FOLLOW			0x00000400	// spectate following another player
#define PMF_SCOREBOARD		0x00000800	// spectate as a scoreboard
#define PMF_INVULEXPAND		0x00001000	// invulnerability sphere set to full size
