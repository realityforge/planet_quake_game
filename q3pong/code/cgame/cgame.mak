...
!MESSAGE No configuration specified. Defaulting to cgame - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "cgame - Win32 Release" && "$(CFG)" != "cgame - Win32 Debug"
...
ALL : "..\Debug\cgamex86.dll" "$(OUTDIR)\cgame.bsc"
...
CLEAN :
	...
	-@erase "..\Debug\cgamex86.dll"
	-@erase "..\Debug\cgamex86.ilk"
...
LINK32=link.exe
LINK32_FLAGS=/nologo /base:"0x30000000" /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\cgamex86.pdb" /map:"$(INTDIR)\cgamex86.map" /debug /machine:I386 /def:".\cgame.def" /out:"..\Debug/cgamex86.dll" /implib:"$(OUTDIR)\cgamex86.lib" 
DEF_FILE= \
	".\cgame.def"
LINK32_OBJS= \
	"$(INTDIR)\bg_misc.obj" \
...
"..\Debug\cgamex86.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
"$(INTDIR)\cg_q3pong.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "cgame - Win32 Debug"


"$(INTDIR)\cg_q3pong.obj"	"$(INTDIR)\cg_q3pong.sbr" : $(SOURCE) "$(INTDIR)"
