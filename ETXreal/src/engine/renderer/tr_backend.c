	...
	else if(skyboxportal)
	{
		...
		{						// portal scene, clear whatever is necessary
			...
			{					// fastsky: clear color
				...
				{
					qglClearColor(glfogsettings[FOG_PORTALVIEW].color[0], glfogsettings[FOG_PORTALVIEW].color[1],
				...
				{
					qglClearColor(glfogsettings[FOG_CURRENT].color[0], glfogsettings[FOG_CURRENT].color[1],
