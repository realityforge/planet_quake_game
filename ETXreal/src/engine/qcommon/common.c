...
#define DEF_COMHUNKMEGS "384"	// RF, increased this, some maps are exceeding 56mb // JPW NERVE changed this for multiplayer back to 42, 56 for depot/mp_cpdepot, 42 for everything else
...
void Com_SetRecommended()
{
	...
	else if(cpuSpeed < 200)
	{							// do the < 200 check just in case we barf, better than falling back to ugly fast
		if(goodVideo)
		{
