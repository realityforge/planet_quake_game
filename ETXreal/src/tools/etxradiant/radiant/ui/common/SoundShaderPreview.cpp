...
void SoundShaderPreview::setSoundFile(const std::string& soundFile) {
...
//	gtk_tree_view_set_model(GTK_TREE_VIEW(_treeView), NULL);
	...
	gtk_widget_set_sensitive(_widget, !_soundFile.empty());
...
void SoundShaderPreview::onPlay(GtkButton* button, SoundShaderPreview* self) {
	...
	std::string selectedFile = "sound/" + self->getSelectedSoundFile();
