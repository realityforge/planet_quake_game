...
void Blocked_Door( gentity_t *ent, gentity_t *other ) {
	...
	//NT - or a player proxy
	if ( !other->client && other->s.eType != ET_PLAYER_PROXY ) {
		// except CTF flags!!!!
...
static void Touch_DoorTriggerSpectator( gentity_t *ent, gentity_t *other, trace_t *trace ) {
	...
	TeleportPlayer(other, origin, angles, qfalse, qtrue, qfalse );
}
...
void Touch_DoorTrigger( gentity_t *ent, gentity_t *other, trace_t *trace ) {
	//NT - door triggers work the same way for watchers as spectators
