...
//NT - versioning check
#define ALTERNATEFIRE_VERSION	"1.52"
...
extern	vec4_t		colorLightBlue; //NT
...
#define BUTTON_ATTACK2		32			//NT - secondary attack button
