...
*/
	{
		...
		0, 0 },
/* icon */		"icons/haste",
/* pickup */	"Haste", //NT - was called "Speed"
		30,
		IT_POWERUP,
		PW_HASTE,
/* precache */ "",
...
//NT - added chaff
/*QUAKED weapon_chaff (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_chaff",
		"sound/misc/w_pkup.wav",
...
//NT - added second plasma
/*QUAKED weapon_plasmagun2 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_plasmagun2", 
		"sound/misc/w_pkup.wav",
...
//NT - added proximity grenade weapon
/*QUAKED weapon_grenadelauncher (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"proximityGrenade",
		...
		0, 0, 0},
/* icon */		"icons/iconw_grenade",
/* pickup */	"Proximity Grenade Launcher",
		10,
		IT_WEAPON,
		WP_PROX_LAUNCHER,
/* precache */ "",
/* sounds */ "sound/weapons/grenade/hgrenb1a.wav sound/weapons/grenade/hgrenb2a.wav"
	...
	//
	//NT - new POWERUP ITEMS
	//
/*QUAKED item_accuracy (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"item_accuracy", 
		"sound/items/accuracy.wav",
        { "models/powerups/instant/accuracy.md3",
        "models/powerups/instant/accuring.md3",
		0, 0 },
/* icon */		"icons/accuracy",
/* pickup */	"Accuracy",
		30,
...
/*QUAKED item_speed (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"item_speed",
		"sound/items/speed.wav",
        { "models/powerups/instant/speed.md3", 
		"models/powerups/instant/speedring.md3", 
		0, 0 },
/* icon */		"icons/speed",
/* pickup */	"Speed",
		30,
...
/*QUAKED item_vitality (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"item_vitality",
		"sound/items/vitality.wav",
        { "models/powerups/instant/vital.md3", 
		"models/powerups/instant/vital_ring.md3", 
		0, 0 },
/* icon */		"icons/vital",
/* pickup */	"Vitality",
		30,
...
/*QUAKED holdable_hologram (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"holdable_hologram", 
		"sound/items/hologram.wav",
        { "models/powerups/holdable/hologram.md3", 
//		"models/powerups/holdable/holoring.md3", 
		0,
		0, 0 },
/* icon */		"icons/hologram",
/* pickup */	"Hologram Generator",
		30,
		IT_HOLDABLE,
		HI_HOLOGRAM,
/* precache */ "",
...
/*QUAKED item_hologram (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"item_hologram",
		"sound/items/hologram.wav",
...
#endif
		//NT - vitality powerup
		if ( ps->powerups[PW_VITALITY] ) {
			if ( ps->stats[STAT_HEALTH] >= ps->stats[STAT_MAX_HEALTH] * 3 ) {
				return qfalse;
			}
...
//#endif
	...
	"EV_SHOTGUN2",
	"EV_RAILTRAIL2",
	"EV_POWERUP_PROTECTION",
	"EV_CREATE_WEB",
	"EV_DESTROY_WEBS",
	"EV_START_OVERLOAD",
	"EV_RAILGUN_PREFIRE",
	"EV_PROX_GREN_TRIGGER",
	"EV_LIGHTNING_SPLASH",
	"EV_PROXIMITY_TICK",
	"EV_POWERUP_VITALITY",
	"EV_JUMP_PAD_ENTITY",
...
//NT - added this so we have something consistent to go to
/*
========================
BG_GetWeaponReloadTime
========================
*/
int BG_GetWeaponReloadTime( int weapon, qboolean secondary ) {
	if (!secondary) {
		switch( weapon ) {
		case WP_GAUNTLET:
			return 400;
	...
	//NT - different switch for secondary
	else {
		switch( weapon ) {
		case WP_GAUNTLET:
			return 50;
...
//NT - needed to know in a few places
qboolean BG_IsHitScanWeapon( int weapon, qboolean secondary ) {
	if (!secondary) {
		switch( weapon ) {
		case WP_GAUNTLET:
			return qfalse;
