...
//NT - new menu options
#define ID_SHOWHINTS			138
#define ID_CHATFILTER			139
#define ID_NAMEFILTER			140
#define ID_ALLOWFORCEFILTERS	141
#define ID_BACK					142
...
typedef struct {
	...
	//NT - new menu options
	menuradiobutton_s	showhints;
	menuradiobutton_s	chatfilter;
	menuradiobutton_s	namefilter;
	menuradiobutton_s	allowforcefilters;
	menubitmap_s		back;
...
static void Preferences_SetMenuItems( void ) {
	...
	//NT - new menu options
	s_preferences.showhints.curvalue		= trap_Cvar_VariableValue( "cg_showHints" ) != 0;
	s_preferences.chatfilter.curvalue		= trap_Cvar_VariableValue( "cg_chatFilter" ) != 0;
	s_preferences.namefilter.curvalue		= trap_Cvar_VariableValue( "cg_nameFilter" ) != 0;
	s_preferences.allowforcefilters.curvalue	= trap_Cvar_VariableValue( "cg_allowForceFilters" ) != 0;
}
...
static void Preferences_Event( void* ptr, int notification ) {
	...
	//NT - new menu options
	case ID_SHOWHINTS:
		trap_Cvar_SetValue( "cg_showHints", s_preferences.showhints.curvalue );
		break;
	...
	case ID_NAMEFILTER:
		trap_Cvar_SetValue( "cg_nameFilter", s_preferences.namefilter.curvalue );
		break;

	case ID_ALLOWFORCEFILTERS:
		trap_Cvar_SetValue( "cg_allowForceFilters", s_preferences.allowforcefilters.curvalue );
		break;
...
static void Preferences_MenuInit( void ) {
	...
	//NT - shift it up to make room for other options
	y = 104;
	...
	//NT - new menu options
	y += BIGCHAR_HEIGHT+2;
	s_preferences.showhints.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.showhints.generic.name	   = "Show Hints:";
	s_preferences.showhints.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.showhints.generic.callback = Preferences_Event;
	s_preferences.showhints.generic.id       = ID_SHOWHINTS;
	s_preferences.showhints.generic.x	       = PREFERENCES_X_POS;
	s_preferences.showhints.generic.y	       = y;

	y += BIGCHAR_HEIGHT+2;
	s_preferences.chatfilter.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.chatfilter.generic.name	   = "Filter Chat:";
	...
	y += BIGCHAR_HEIGHT+2;
	s_preferences.namefilter.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.namefilter.generic.name	   = "Filter Names:";
	s_preferences.namefilter.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.namefilter.generic.callback = Preferences_Event;
	s_preferences.namefilter.generic.id       = ID_NAMEFILTER;
	s_preferences.namefilter.generic.x	       = PREFERENCES_X_POS;
	s_preferences.namefilter.generic.y	       = y;

	y += BIGCHAR_HEIGHT+2;
	s_preferences.allowforcefilters.generic.type     = MTYPE_RADIOBUTTON;
	s_preferences.allowforcefilters.generic.name	   = "Server Can Force Filters:";
	s_preferences.allowforcefilters.generic.flags	   = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_preferences.allowforcefilters.generic.callback = Preferences_Event;
	s_preferences.allowforcefilters.generic.id       = ID_ALLOWFORCEFILTERS;
	s_preferences.allowforcefilters.generic.x	       = PREFERENCES_X_POS;
	s_preferences.allowforcefilters.generic.y	       = y;
	...
	//NT - new menu options
	Menu_AddItem( &s_preferences.menu, &s_preferences.showhints );
	Menu_AddItem( &s_preferences.menu, &s_preferences.chatfilter );
	Menu_AddItem( &s_preferences.menu, &s_preferences.namefilter );
	Menu_AddItem( &s_preferences.menu, &s_preferences.allowforcefilters );
