...
static void Main_MenuDraw( void ) {
	...
	float			adjust;
	float			x, y, w, h;
	vec4_t			color = {0.5f, 0, 0, 1}; //NT
	vec4_t			color2 = {0.1f, 0.4f, 0.5f, 1}; //NT - color for alternate fire string
	...
	if (uis.demoversion) {
		...
		//NT - moved up the "Quake III Arena" copyright notice, added mine
		UI_DrawString( 320, 425, "Quake III Arena(c) 1999-2000, Id Software, Inc.  All Rights Reserved", UI_CENTER|UI_SMALLFONT, color );
		UI_DrawString( 320, 445, "Alternate Fire Mod Version " ALTERNATEFIRE_VERSION " - Neil Toronto - 2001", UI_CENTER|UI_SMALLFONT, color2 );
		UI_DrawString( 320, 460, "http://www.planetquake.com/alternatefire", UI_CENTER|UI_SMALLFONT, color2 );
	}
}
