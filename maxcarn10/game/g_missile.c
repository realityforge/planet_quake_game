...
(REVEL 16:8)  ... and power was given unto him to scorch men with fire.
--Bible (KJV)
================
*/
void plasma_think( gentity_t *ent ) {
	G_RadiusDamage( ent->r.currentOrigin, ent->parent, ent->splashDamage, ent->splashRadius, NULL
			, ent->splashMethodOfDeath );
	ent->nextthink += 50;
}
