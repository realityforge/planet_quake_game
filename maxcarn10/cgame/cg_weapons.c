...
void CG_RegisterWeapon( int weaponNum ) {
	...
	case WP_MACHINEGUN:
		...
		cgs.media.railExplosionShader = trap_R_RegisterShader( "railExplosion" );		// CCH
		cgs.media.railRingsShader = trap_R_RegisterShader( "railDisc" );			// CCH
		cgs.media.railCoreShader = trap_R_RegisterShader( "railCore" );				// CCH
		break;
	...
	case WP_SHOTGUN:
		...
		cgs.media.grenadeExplosionShader = trap_R_RegisterShader( "grenadeExplosion" );		// CCH
		break;
	...
	case WP_BFG:
		...
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBolt" );			// CCH
