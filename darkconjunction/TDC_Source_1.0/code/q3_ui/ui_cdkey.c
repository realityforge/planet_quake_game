...
static void UI_CDKeyMenu_DrawKey( void *self ) {
	...
	UI_FillRect( x, y, 16 * BIGCHAR_WIDTH, BIGCHAR_HEIGHT, tdc_listbar_color );
	...
	if( val == 1 ) {
		UI_DrawProportionalString( 320, 376, "Please enter your CD Key", UI_CENTER|UI_SMALLFONT, tdc_text_color);
	}
	else if ( val == 0 ) {
		UI_DrawProportionalString( 320, 376, "The CD Key appears to be valid, thank you", UI_CENTER|UI_SMALLFONT, color_white );
	}
	else {
		UI_DrawProportionalString( 320, 376, "The CD Key is not valid", UI_CENTER|UI_SMALLFONT, tdc_text_color);
	}
}
...
static void UI_CDKeyMenu_Init( void ) {
	...
	cdkeyMenuInfo.accept.generic.x					= 640-32;
	cdkeyMenuInfo.accept.generic.y					= 480-36;
	cdkeyMenuInfo.accept.string						= "accept";
	cdkeyMenuInfo.accept.color						= tdc_text_color;
	cdkeyMenuInfo.accept.style						= UI_RIGHT;
	...
	cdkeyMenuInfo.back.generic.x					= 32;
	cdkeyMenuInfo.back.generic.y					= 480-36;
	cdkeyMenuInfo.back.string						= "back";
	cdkeyMenuInfo.back.color						= tdc_text_color;
	cdkeyMenuInfo.back.style						= UI_LEFT;
