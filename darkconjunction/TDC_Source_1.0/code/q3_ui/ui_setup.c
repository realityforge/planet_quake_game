...
#define ART_FRAMEL		"menu/art/dark_scene"
...
static void Setup_ResetDefaults_Draw( void ) {
	...
	UI_DrawProportionalString( SCREEN_WIDTH/2, 356 + PROP_HEIGHT * 1, "options to their default values.", UI_CENTER|UI_SMALLFONT, tdc_text_color );
}
...
static void UI_SetupMenu_Init( void ) {
	...
	setupMenuInfo.framel.width  					= 640;
	setupMenuInfo.framel.height  					= 480;
...
//	y += SETUP_MENU_VERTICAL_SPACING;
	...
	setupMenuInfo.setupcontrols.color				= tdc_text_color;
	setupMenuInfo.setupcontrols.style				= UI_SMALLFONT|UI_CENTER;
	...
	setupMenuInfo.setupsystem.color					= tdc_text_color;
	setupMenuInfo.setupsystem.style					= UI_SMALLFONT|UI_CENTER;
	...
	setupMenuInfo.game.color						= tdc_text_color;
	setupMenuInfo.game.style						= UI_SMALLFONT|UI_CENTER;
	...
	setupMenuInfo.cdkey.color						= tdc_text_color;
	setupMenuInfo.cdkey.style						= UI_SMALLFONT|UI_CENTER;
	...
	if( !trap_Cvar_VariableValue( "cl_paused" ) ) {
		...
		setupMenuInfo.load.color						= tdc_text_color;
		...
		setupMenuInfo.save.color						= tdc_text_color;
		...
		setupMenuInfo.defaults.color					= tdc_text_color;
		setupMenuInfo.defaults.style					= UI_SMALLFONT|UI_CENTER;
	}
	...
	setupMenuInfo.back.generic.y					= 480-36;
	setupMenuInfo.back.string					= "back";
	setupMenuInfo.back.color					= tdc_text_color;
