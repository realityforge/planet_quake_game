...
void SpecifyLeague_MenuInit( void )
{
	...
	s_specifyleague.back.generic.type	  = MTYPE_PTEXT;
	...
	s_specifyleague.back.generic.x		  = 12;
	s_specifyleague.back.generic.y		  = 480-PROP_HEIGHT;
	s_specifyleague.back.string  		  = "back";
	s_specifyleague.back.color  		  = color_red;
	s_specifyleague.back.style         = UI_LEFT;
