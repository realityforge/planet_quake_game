...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.framel.generic.y			= 0;
	soundOptionsInfo.framel.width				= 640;
	soundOptionsInfo.framel.height				= 480;
...
*/
	...
	soundOptionsInfo.graphics.color				= tdc_text_color;
	...
	soundOptionsInfo.display.color				= tdc_text_color;
	...
	soundOptionsInfo.sound.color				= tdc_text_color;
...
*/
	...
	soundOptionsInfo.back.generic.x				= 32;
	soundOptionsInfo.back.generic.y				= 480-36;
	soundOptionsInfo.back.string				= "back";
	soundOptionsInfo.back.color					= tdc_text_color;
