...
void UI_MainMenu( void ) {
	...
	s_main.singleplayer.generic.name		= ART_BACK0;
	s_main.singleplayer.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_main.singleplayer.generic.x			= 320;
	s_main.singleplayer.generic.y			= y;
	s_main.singleplayer.generic.id			= ID_SINGLEPLAYER;
	s_main.singleplayer.generic.callback	= Main_MenuEvent; 
	s_main.singleplayer.width				= 128;
	s_main.singleplayer.height				= 64;
	s_main.singleplayer.focuspic			= ART_BACK1;
...
//	y += MAIN_MENU_VERTICAL_SPACING;
	...
	s_main.setup.generic.name				= ART_BACK0;
	s_main.setup.generic.flags				= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_main.setup.generic.x					= 320;
	s_main.setup.generic.y					= y;
	s_main.setup.generic.id					= ID_SETUP;
	s_main.setup.generic.callback			= Main_MenuEvent; 
	s_main.setup.width						= 128;
	s_main.setup.height						= 64;
	s_main.setup.focuspic					= ART_BACK1;
...
//	s_main.mods.style					= style;
	...
	s_main.exit.color						= tdc_text_color;
