...
static void UI_TeamOrdersMenu_Init( void ) {
	...
	teamOrdersMenuInfo.back.generic.type		= MTYPE_PTEXT;
	...
	teamOrdersMenuInfo.back.generic.x			= 32;
	teamOrdersMenuInfo.back.generic.y			= 480-36;
	teamOrdersMenuInfo.back.string				= "back";
	teamOrdersMenuInfo.back.color				= tdc_text_color;
	teamOrdersMenuInfo.back.style				= UI_LEFT;
