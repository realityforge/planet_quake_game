...
#define ART_CONFIRM_FRAME	"menu/art/dark_scene"
...
static void ConfirmMenu_Draw( void ) {
	UI_DrawNamedPic( 0 , 0 , 640 , 480 , ART_CONFIRM_FRAME );
	UI_DrawProportionalString( 320, 204, s_confirm.question, UI_SMALLFONT|UI_CENTER|UI_INVERSE, tdc_text_color );
	UI_DrawProportionalString( s_confirm.slashX, 265, "/", UI_SMALLFONT|UI_LEFT|UI_INVERSE, tdc_text_color);
...
void UI_ConfirmMenu( const char *question, void (*draw)( void ), void (*action)( qboolean result ) ) {
	...
	s_confirm.yes.color				= tdc_text_color;
	s_confirm.yes.style				= UI_SMALLFONT|UI_LEFT;
	...
	s_confirm.no.color			    = tdc_text_color;
	s_confirm.no.style			    = UI_SMALLFONT|UI_LEFT;
