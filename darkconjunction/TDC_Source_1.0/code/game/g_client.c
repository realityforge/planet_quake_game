...
// JPL - no teleport, no entering message
...
//	client->areabits = savedAreaBits;
	...
	ent->stop_event=level.time+1000;	// JPL
	...
	client->ps.stats[STAT_WEAPONS] = 0; //EHL

//	client->ps.stats[STAT_WEAPONS] |= ( 1 << WP_GAUNTLET );	// JPL
	client->ps.ammo[WP_BONE] = 1;
	client->ps.ammo[WP_GRAPPLING_HOOK] = -1;
	

	// health will count down towards max_health
	ent->health = client->ps.stats[STAT_HEALTH] = client->ps.stats[STAT_MAX_HEALTH]; // + 25; JPL 
	...
	if ( ent->client->sess.sessionTeam == TEAM_SPECTATOR ) {
		...
		client->ps.weapon = WP_NONE;		// JPL
		client->ps.weaponstate = WEAPON_DOWN;
