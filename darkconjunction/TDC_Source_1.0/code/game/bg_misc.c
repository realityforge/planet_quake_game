...
int weapon_max_ammo[WP_NUM_WEAPONS]={
	0,
	1,
	60,
	60,
...
int weapon_fire_ammo[WP_NUM_WEAPONS]={
	0,
	0,
	1,
	3,
...
int weapon_fire_time[WP_NUM_WEAPONS]={
	0,
	350,	// los otros 650 estan en el swing en g_weapon.c
	1000,
	1000,
	100,
	1,
...
int weapon_reload_ammo[WP_NUM_WEAPONS]={
	0,
	200,
	6,
	3,
...
int weapon_reload_time[WP_NUM_WEAPONS]={
	0,
	0,
	2250,
	2000,
...
*/
	{
		...
		"models/powerups/health/medkit.md3", // EHL - modified filename
		"models/powerups/health/medkit.md3", // EHL - modified filename
...
/*QUAKED weapon_bone (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_bone", 
		"sound/misc/w_pkup.wav",
        { "models/weapons2/bone/bone.md3",
		"models/weapons2/bone/bone_hud.md3",
		0, 0},
/* icon */		"icons/icon_bone",
/* pickup */	"Bone",
		1,
		IT_WEAPON,
		WP_BONE,
...
/*QUAKED weapon_gun (.3 .3 1) (-16 -16 -16) (16 16 16) suspended			// TDC GUN
*/
	{
		"weapon_gun", 
		"sound/misc/w_pkup.wav",
...
/*QUAKED weapon_trishotgun (.3 .3 1) (-16 -16 -16) (16 16 16) suspended		// TDC TRISHOTGUN
*/
	{
		"weapon_trishotgun", 
		"sound/misc/w_pkup.wav",
        { "models/weapons2/trishotgun/trishotgun.md3",
		"models/weapons2/trishotgun/trishotgun_hud.md3",
		0, 0},
/* icon */		"icons/icon_trishotgun",
/* pickup */	"Trishotgun",
		3,
		IT_WEAPON,
		WP_TRISHOTGUN,
...
/*QUAKED weapon_mg42 (.3 .3 1) (-16 -16 -16) (16 16 16) suspended		// TDC MG42
*/
	{
		"weapon_mg42", 
		"sound/misc/w_pkup.wav",
        { "models/weapons2/mg42/mg42.md3", 
		"models/weapons2/mg42/mg42_hud.md3", 
		0, 0},
/* icon */		"icons/icon_mg42",
/* pickup */	"MG42",
		50,
		IT_WEAPON,
		WP_MG42,
...
*/
	{
        ...
        { "models/powerups/ammo/shellbox.md3", 
		0, 0, 0},
/* icon */		"",
/* pickup */	"Shells",
		30,
...
*/
	{
		"ammo_bullets",
		"sound/misc/am_pkup.wav",
        { "models/powerups/ammo/bullet_box.md3", 
		0, 0, 0},
/* icon */		"",
/* pickup */	"Bullets",
		24,
...
*/
	{
		"ammo_mg42",
		"sound/misc/am_pkup.wav",
        { "models/powerups/ammo/mg42_ammo.md3", 
		0, 0, 0},
/* icon */		"",
/* pickup */	"MG42 Bullets",
		100,
...
qboolean BG_CanItemBeGrabbed( int gametype, const entityState_t *ent, const playerState_t *ps ) {
	...
	case IT_AMMO:
		if ( ps->ammo[ item->giTag ] >= weapon_max_ammo[item->giTag] ) {
