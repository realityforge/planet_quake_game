...
EHL - No longer draws scoreboard,
      now it draws weaponbar.
=================
*/
qboolean CG_DrawOldScoreboard( void ) {
	...
	// EHL - Lines before are left so that weapon bar will show only
	// if the scoreboard would have been show.
	cg.weaponSelectTime = cg.time; // shows weaponbar
