...
#define	GAMEVERSION	"Q3-Geoball-0.1b"
...
struct gentity_s {
	...
	vec3_t      teleloc;
 	int         istelepoint;
	//32bit mask for 32 clients if this should trigger for them
	int			raceMask;
// raynorpat: Ageia PhysX stuff
	float			mass;
	void		   *nxactor;
//endnew
};
...
typedef struct {
	...
	gentity_t	*raceTimeCheck;		//Head of checkpoints
//newq3ball	
//	int			numObjectives;
//endnew
#ifdef MISSIONPACK
...
// g_target.c
//
void G_UpdateObjectives(void);	// JUHOX
qboolean G_IsObjectiveFulfilled(const char* name, int minstate, int maxstate);	// JUHOX
//endnew
