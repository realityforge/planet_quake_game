...
// raynorpat: Ageia PhysX
#ifdef PHYSX
void			SP_func_box(gentity_t *ent);
#endif
...
spawn_t	spawns[] = {
	...
	{"target_timer_start", SP_target_timer_start},
	{"target_timer_end", SP_target_timer_end},
	{"target_timer_check", SP_target_timer_check},
