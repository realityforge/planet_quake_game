...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.gibAbdomen = trap_R_RegisterModel( "models/breakables/wood01.md3" );
	cgs.media.gibArm = trap_R_RegisterModel( "models/breakables/wood02.md3" );
	cgs.media.gibChest = trap_R_RegisterModel( "models/breakables/wood03.md3" );
	cgs.media.gibFist = trap_R_RegisterModel( "models/breakables/wood04.md3" );
	cgs.media.gibFoot = trap_R_RegisterModel( "models/breakables/wood02.md3" );
	cgs.media.gibForearm = trap_R_RegisterModel( "models/breakables/wood03.md3" );
	cgs.media.gibIntestine = trap_R_RegisterModel( "models/breakables/wood04.md3" );
	cgs.media.gibLeg = trap_R_RegisterModel( "models/breakables/wood02.md3" );
	cgs.media.gibSkull = trap_R_RegisterModel( "models/breakables/wood03.md3" );
	cgs.media.gibBrain = trap_R_RegisterModel( "models/breakables/wood04.md3" );
...
void CG_LoadMenus(const char *menuFile) {
	...
	Com_Printf("CGAME menu load time = %d milli seconds\n", trap_Milliseconds() - start);
