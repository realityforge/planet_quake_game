...
vmCvar_t	cg_railscrew;
vmCvar_t	cg_railscrewCount;
vmCvar_t	cg_railgunExplosions;
vmCvar_t	cg_HUDcolor;
vmCvar_t	cg_drawHUD;
vmCvar_t	cg_explosionParticles;
vmCvar_t	cg_drawKill;
/***************************************/
vmCvar_t	cg_railTrailTime;
...
/*******************************************************************************/
	{ &cg_railTrailTime, "cg_railTrailTime", "400", CVAR_ARCHIVE  },
	{ &cg_railscrew, "cg_railscrew", "1", CVAR_ARCHIVE  },
	{ &cg_railscrewCount, "cg_railscrewCount", "3", CVAR_ARCHIVE  },
	{ &cg_railgunExplosions, "cg_railgunExplosions", "1", CVAR_ARCHIVE  },
	{ &cg_HUDcolor, "cg_HUDcolor", "0", CVAR_ARCHIVE  },
	{ &cg_drawHUD, "cg_drawHUD", "1", CVAR_ARCHIVE  },
	{ &cg_explosionParticles, "cg_explosionParticles", "10", CVAR_ARCHIVE  },
	{ &cg_drawKill, "cg_drawKill", "1", CVAR_ARCHIVE  },
/*******************************************************************************
	{ &dev_hud_y, "dev_hud_y", "1", CVAR_ARCHIVE },
	{ &dev_shots_y, "dev_shots_y", "1", CVAR_ARCHIVE },
	{ &dev_hits_y, "dev_hits_y", "1", CVAR_ARCHIVE },
	{ &dev_acc_y, "dev_acc_y", "1", CVAR_ARCHIVE },
	{ &dev_defendglow_y, "dev_defendglow_y", "1", CVAR_ARCHIVE },
	{ &dev_defendcount_y, "dev_defendcount_y", "1", CVAR_ARCHIVE },
	{ &dev_assistglow_y, "dev_assistglow_y", "1", CVAR_ARCHIVE },
	{ &dev_assistcount_y, "dev_assistcount_y", "1", CVAR_ARCHIVE },
	{ &dev_captureglow_y, "dev_captureglow_y", "1", CVAR_ARCHIVE },
	{ &dev_capturecount_y, "dev_capturecount_y", "1", CVAR_ARCHIVE }
/*******************************************************************************/
...
static void CG_RegisterGraphics( void ) {
	...
	CG_LoadingString( "corkscrew media" );

/*****************CORKSCREW****************/
/* i use the corkscrew_gfx directory now just to eliminate ANY possible conflicts */

	CG_InitTrippyColors();

	if( cgs.gametype == GT_CTF ) {
		cgs.media.HUD_CTF = trap_R_RegisterShaderNoMip( "corkscrew_gfx/hud_ctf" );
		cgs.media.HUDassist_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/assist_light" );
		cgs.media.HUDdefend_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/defend_light" );
		cgs.media.HUDcapture_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/capture_light" );
	} else {
		cgs.media.HUD = trap_R_RegisterShaderNoMip( "corkscrew_gfx/hud" );
		cgs.media.HUDimpressive_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/impressive_light" );
		cgs.media.HUDexcellent_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/excellent_light" );
		cgs.media.HUDheadshot_light = trap_R_RegisterShaderNoMip( "corkscrew_gfx/headshot_light" );
	}

	cgs.media.trippyQuad = trap_R_RegisterShader( "corkscrew_gfx/quadTrippy" );

	cgs.media.quadboom = trap_R_RegisterModel( "corkscrew_gfx/sphere.md3" );
	cgs.media.quadboomBlue = trap_R_RegisterShader( "corkscrew_gfx/quadWeapon2" );
	cgs.media.medalFrags = trap_R_RegisterShaderNoMip( "corkscrew_gfx/medal_frags" );

	cgs.media.trippyBloodTrail = trap_R_RegisterShader( "corkscrew_gfx/trippyBloodTrail" );

	cgs.media.quadBloodMarkShader = trap_R_RegisterShader( "corkscrew_gfx/quadBloodMark" );
	cgs.media.quadBurnMarkShader = trap_R_RegisterShader( "corkscrew_gfx/quadBurnMark" );

	if( cgs.gametype >= GT_TEAM ) {
		cgs.media.quadboomRed = trap_R_RegisterShader( "corkscrew_gfx/quadRedWeapon2" );
		cgs.media.redQuadWeaponShader = trap_R_RegisterShader("corkscrew_gfx/quadRedWeapon" );
		cgs.media.redQuadBurnMarkShader = trap_R_RegisterShader( "corkscrew_gfx/redQuadBurnMark" );
	}

	cgs.media.railgunCharge = trap_S_RegisterSound( "corkscrew_sfx/rail_up.wav", qfalse );
	cgs.media.railgunShaders[0].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionBlue" );
	cgs.media.railgunShaders[0].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleBlue" );
	cgs.media.railgunShaders[1].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionGreen" );
	cgs.media.railgunShaders[1].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleGreen" );
	cgs.media.railgunShaders[2].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionLightblue" );
	cgs.media.railgunShaders[2].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleLightblue" );
	cgs.media.railgunShaders[3].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionRed" );
	cgs.media.railgunShaders[3].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleRed" );
	cgs.media.railgunShaders[4].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionPink" );
	cgs.media.railgunShaders[4].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particlePink" );
	cgs.media.railgunShaders[5].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionYellow" );
	cgs.media.railgunShaders[5].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleYellow" );
	cgs.media.railgunShaders[6].explosionShader = trap_R_RegisterShader( "corkscrew_gfx/rocketExplosionWhite" );
	cgs.media.railgunShaders[6].particleShader = trap_R_RegisterShader( "corkscrew_gfx/particleWhite" );
...
*/
	cgs.media.gibs[0] = trap_R_RegisterModel( "models/gibs/skull.md3" );
	cgs.media.gibs[1] = trap_R_RegisterModel( "models/gibs/brain.md3" );
	cgs.media.gibs[2] = trap_R_RegisterModel( "models/gibs/abdomen.md3" );
	cgs.media.gibs[3] = trap_R_RegisterModel( "models/gibs/arm.md3" );
	cgs.media.gibs[4] = trap_R_RegisterModel( "models/gibs/chest.md3" );
	cgs.media.gibs[5] = trap_R_RegisterModel( "models/gibs/fist.md3" );
	cgs.media.gibs[6] = trap_R_RegisterModel( "models/gibs/foot.md3" );
	cgs.media.gibs[7] = trap_R_RegisterModel( "models/gibs/forearm.md3" );
	cgs.media.gibs[8] = trap_R_RegisterModel( "models/gibs/intestine.md3" );
	cgs.media.gibs[9] = trap_R_RegisterModel( "models/gibs/leg.md3" );
	...
	// corkscrew
	cgs.media.energyMarkShader = trap_R_RegisterShader( "corkscrew_gfx/rail_mrk" );
