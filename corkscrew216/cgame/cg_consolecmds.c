...
=================
CG_ConComDummy_f
Console Command Dummy, for commands without use
=================
*/

static void CG_ConComDummy_f( void ) {
}
...
static consoleCommand_t	commands[] = {
	...
	{ "weapnext", CG_ConComDummy_f /*CG_NextWeapon_f*/ },
	{ "weapprev", CG_ConComDummy_f /*CG_PrevWeapon_f*/ },
	{ "weapon", CG_ConComDummy_f /*CG_Weapon_f*/ },
...
qboolean CG_ConsoleCommand( void ) {
	...
	for ( i = 0 ; i < sizeof( commands ) / sizeof( commands[0] ) ; i++ ) {
		if ( !Q_stricmp( cmd, commands[i].cmd ) ) {
			if( commands[i].function ) commands[i].function();
			return qtrue;
		}
	}
...
void CG_InitConsoleCommands( void ) {
	...
	//
	// CORKSCREW random skirmish, ui will trap this one
	trap_AddCommand ("randomskirmish");
	trap_AddCommand ("skirmish");
	// CORKSCREW additem command, for easier adding of powerups ( DOES ANYONE USE THIS???? )
