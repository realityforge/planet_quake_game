...
static void UI_SetupMenu_Event( void *ptr, int event ) {
	...
	case ID_SERVER_GAME:
		UI_server_preferencesMenu( qfalse );
		break;
...
static void UI_SetupMenu_Init( void ) {
	...
	setupMenuInfo.game.string						= "CLIENT OPTIONS";
	setupMenuInfo.game.color						= color_red;
	setupMenuInfo.game.style						= UI_CENTER;

	y += SETUP_MENU_VERTICAL_SPACING;
	setupMenuInfo.servergame.generic.type					= MTYPE_PTEXT;
	setupMenuInfo.servergame.generic.flags				= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	setupMenuInfo.servergame.generic.x					= 320;
	setupMenuInfo.servergame.generic.y					= y;
	setupMenuInfo.servergame.generic.id					= ID_SERVER_GAME;
	setupMenuInfo.servergame.generic.callback				= UI_SetupMenu_Event;
	setupMenuInfo.servergame.string						= "SERVER OPTIONS";
	setupMenuInfo.servergame.color						= color_red;
	setupMenuInfo.servergame.style						= UI_CENTER;
	...
	Menu_AddItem( &setupMenuInfo.menu, &setupMenuInfo.servergame );
