...
//
// ui_server_preferences.c
//
extern void UI_server_preferencesMenu( qboolean allowConfig );
extern void server_preferences_Cache( void );
...
// ui_main.c
//
// CORKSCREW RANDOM SKIRMISH, called from ui_main.c and ui_ingame.c
// if in-game, bots need to be kicked, then added, and then change the map
// so player precaches all the bots' models
//
void UI_RandomSkirmish( qboolean inGame );
void UI_SkirmishByMap( char *mapname, qboolean inGame );
// also make the accuracy challenge available via the command line...
