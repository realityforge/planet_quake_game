...
static void UI_RemoveBotsMenu_Init( void ) {
	...
	removeBotsMenuInfo.removeall.generic.type		= MTYPE_PTEXT;
	...
	removeBotsMenuInfo.removeall.generic.y		= 272;
	removeBotsMenuInfo.removeall.generic.callback	= UI_RemoveBotsMenu_DeleteEvent;
	removeBotsMenuInfo.removeall.string			= "REMOVE ALL BOTS";
	removeBotsMenuInfo.removeall.color			= color_red;
