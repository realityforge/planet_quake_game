...
static void PlayerSettings_MenuInit( void ) {
	...
	s_playersettings.effects.generic.bottom		= y + 2*PROP_HEIGHT - 8;
	...
	s_playersettings.effects2.generic.bottom	= y + 2*PROP_HEIGHT - 8;
	s_playersettings.effects2.numitems			= 7;

	y += 16;
	s_playersettings.effects3.generic.type		= MTYPE_SPINCONTROL;
	s_playersettings.effects3.generic.id		= ID_EFFECTS3;
	s_playersettings.effects3.generic.flags		= QMF_NODEFAULTINIT;
	s_playersettings.effects3.generic.ownerdraw	= PlayerSettings_DrawEffects;
	s_playersettings.effects3.generic.x			= 192;
	s_playersettings.effects3.generic.y			= y;
	s_playersettings.effects3.generic.left		= 192 - 8;
	s_playersettings.effects3.generic.top		= y;
	s_playersettings.effects3.generic.right		= 192 + 200;
	s_playersettings.effects3.generic.bottom	= y + 2*PROP_HEIGHT - 8;
	s_playersettings.effects3.numitems			= 7;
