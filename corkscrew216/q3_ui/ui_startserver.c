...
static void ServerOptions_Event( void* ptr, int event ) {
	...
	case ID_SERVERSETUP:
		...
		UI_server_preferencesMenu( qtrue );
		break;
...
static void ServerOptions_StatusBar( void* ptr ) {
	switch( ((menucommon_s*)ptr)->id ) {
	case ID_SERVERSETUP:
		UI_DrawString( 320, 440, "Configure CorkScrew", UI_CENTER|UI_SMALLFONT, colorWhite );
		break;
	default:
...
static void ServerOptions_MenuInit( qboolean multiplayer ) {
	...
	s_serveroptions.serversetup.generic.type	= MTYPE_PTEXT;
	s_serveroptions.serversetup.generic.flags	= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_serveroptions.serversetup.generic.x		= 320;
	s_serveroptions.serversetup.generic.y		= 380 + BIGCHAR_HEIGHT+2;
	s_serveroptions.serversetup.generic.id		= ID_SERVERSETUP;
	s_serveroptions.serversetup.generic.callback	= ServerOptions_Event;
	s_serveroptions.serversetup.string		= "CORKSCREW OPTIONS";
	s_serveroptions.serversetup.color			= color_red;
	s_serveroptions.serversetup.style			= UI_CENTER;
	s_serveroptions.serversetup.generic.statusbar  = ServerOptions_StatusBar;
	...
	Menu_AddItem( &s_serveroptions.menu, &s_serveroptions.serversetup );
