...
void TeleportPlayer( gentity_t *player, vec3_t origin, vec3_t angles ) {
	gentity_t	*tent;
	// if teleporting into spawn protected player, you'll get telefragged >:)
	qboolean	telefragged;
	// spectator bug... comment this line and have fun >:)
	telefragged = qfalse;
	...
	if ( telefragged ) G_Damage ( player, NULL, NULL, NULL, NULL,
...
void InitShooter( gentity_t *ent, int weapon ) {
	...
	RegisterItem( BG_FindItemForWeapon( weapon ), qtrue );
